...
// Simulated 'external' data sources (treat as opaque black-boxes)
const legacyDB = {
fetchAll: () => students,
fetchById: (id) => students.find(s => s.id === id) || null,
fetchByDept: (d) => students.filter(s => s.dept === d),
};

module.exports = {students, legacyDB}